...
interface PlayListDao {
    ...
    fun getAllPlaylistTracks(): List<TrackInPlaylistEntity>
    ...
    @Query("UPDATE playlists SET trackCount = trackCount - 1 WHERE id = :id")
    suspend fun decrementPlaylistTrackCount(id: Int)
